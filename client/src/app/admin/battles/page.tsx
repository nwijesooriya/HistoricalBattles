    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <h1 className="text-2xl font-bold text-gray-900">Manage Battles</h1>
            </div>
            <button
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">War</label>
                    <select
                      required
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              {battles.map((battle) => (
                <tr key={battle._id}>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900">{battle.name}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-500">{battle.date}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-500">{battle.location}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-500">{battle.outcome}</div>
                  </td>
          ...
          {battles.length === 0 && <div className="p-8 text-center text-gray-500">No battles found</div>}
        </div>
      </main>
    </div>
  );
